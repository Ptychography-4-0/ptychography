...
htmlhelp_basename = 'ptychographydoc'
...
latex_documents = [
    (master_doc, 'ptychography.tex', 'Ptychography 4.0 Documentation',
     'Margarete Mustermann', 'manual'),
]
...
man_pages = [
    (master_doc, 'ptychography', 'Ptychography 4.0 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ptychography', 'ptychography Documentation',
     author, 'ptychography', 'One line description of project.',
     'Miscellaneous'),
]
...
# GitHub repo
issues_github_path = "Ptychography-4-0/ptychography"
