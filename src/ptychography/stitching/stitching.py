...
def stitch(objects, wtype = 'weighted', threshold = 10**-12):
# d1, d2  - dimension of the object
# R       - number of peaces to be stitched together
# objects - d1 X d2 X R array containing recovered peaces of object, 
#            required to be stitched   
#
#
# wtype   - selected type of weights to be used in the angular synchronization
#            There are 2 posible choices: 
